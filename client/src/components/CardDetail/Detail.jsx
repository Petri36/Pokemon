...
export const Detail = () => {
  ...
  const truncateString = (str, num) => { // truncar una cadena de texto si es demasiado larga, 
    if (str.length <= num) return str;   // devolviendo una versión acortada de la cadena con tres puntos suspensivos al final.
          ...
          <div className="pokemonData">
            ...
            <section>
              ...
              <div>
                ...
                <progress max="255" value={defense}>
                  {defense}
                </progress>
              </div>
